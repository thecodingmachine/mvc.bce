...
class BCEUtils{
	...
	private $singleFieldRenderers = array();
	private $multiFieldRenderers = array();
	...
	private function initRenderers(){
		$this->singleFieldRenderers = $this->initHandler('SingleFieldRendererInterface');
		$this->multpiFieldRenderers = $this->initHandler('MultiFieldRendererInterface');
	}
	...
	private function beanHelperConvert2Descriptor(BeanFieldHelper $beanField){
		...
		$convertBean->renderer = $this->_match($beanField, array_merge($this->singleFieldRenderers, $this->multiFieldRenderers));
